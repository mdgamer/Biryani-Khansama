...
$sql = "SELECT ordered_item,amount,order_date,status FROM orders where phone_no='$phno' ORDER BY order_date DESC";
	...
	<div class="row text-center padding">
		<div class="col-md-8 footer-left">
			...
			<div class="text-center copyright">
				<p>&copy; Design and Developed by Delta Medan 2019. All rights reserved.</p>
			</div>
		</div>
